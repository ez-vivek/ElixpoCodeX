              ...
              {[
                {
                  ...
                  description:
                    "Supports a wide range of programming languages such as JavaScript, Python, Java, C++, and more.",
                },
                {
                  icon: Sparkles,
                ...
                },
                {
                  ...
                  title: "Quick Copy",
                  description:
                    "Allows you to easily copy source or converted code with a single click.",
                },
                {
                  icon: ArrowLeftRight,
              ...
              <div className="space-y-8">
                <section className="bg-card rounded-lg p-6 shadow-lg border border-border/50">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Welcome to ElixpoCodeX. This tool helps you convert code between
